...
`@andocorp/sdk` ships `AndoClient` with typed REST methods (search, messaging,
threads, members, calls, and tasks), realtime subscriptions
(`client.realtime`), webhook endpoint and delivery management
