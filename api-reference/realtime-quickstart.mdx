...
today — use [webhooks](/developers/webhooks) for anything else.
...
Read the generated [endpoint reference](/api-reference/endpoint-reference)
for the full `POST /realtime/connections` request and response schemas.
